...
export default function StoreSidebarSlider({ sliders, loading }: Props) {
  if (loading) {
    return (
      <div className="hidden xl:block sticky top-20 self-start w-full h-[520px] rounded-2xl bg-gray-100 animate-pulse" />
    );
  }
  ...
  return (
    <div className="hidden xl:block sticky top-20 self-start w-full h-[520px]">
      <Swiper
