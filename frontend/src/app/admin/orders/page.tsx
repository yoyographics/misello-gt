...
const ACTIVE_STATUSES = ['DRAFT', 'PENDING_PAYMENT', 'PAYMENT_RECEIVED', 'CONFIRMED', 'IN_PRODUCTION', 'FINISHED', 'SHIPPED'];
const ALLOWED_TRANSITIONS: Record<string, string[]> = {
  DRAFT: ACTIVE_STATUSES,
  PENDING_PAYMENT: ACTIVE_STATUSES,
  PAYMENT_RECEIVED: ACTIVE_STATUSES,
  CONFIRMED: ACTIVE_STATUSES,
  IN_PRODUCTION: ACTIVE_STATUSES,
  FINISHED: ACTIVE_STATUSES,
  SHIPPED: ACTIVE_STATUSES,
