...
export const CATALOG_PRODUCTS = [
  ...
  { sku: 'R-524', name: 'Sello automático R-524 Circular', categorySlug: 'sello-automatico', shape: ProductShape.CIRCULAR, widthMm: 24, heightMm: 24, widthPx: 579, heightPx: 579, basePrice: 110 },
  { sku: 'R-532', name: 'Sello automático R-532 Circular', categorySlug: 'sello-automatico', shape: ProductShape.CIRCULAR, widthMm: 32, heightMm: 32, widthPx: 768, heightPx: 768, basePrice: 145 },
  { sku: 'R-538', name: 'Sello automático R-538 Circular', categorySlug: 'sello-automatico', shape: ProductShape.CIRCULAR, widthMm: 38, heightMm: 38, widthPx: 909, heightPx: 909, basePrice: 175 },
  { sku: 'R-542', name: 'Sello automático R-542 Circular', categorySlug: 'sello-automatico', shape: ProductShape.CIRCULAR, widthMm: 42, heightMm: 42, widthPx: 1004, heightPx: 1004, basePrice: 205 },
  { sku: 'R-552', name: 'Sello automático R-552 Circular', categorySlug: 'sello-automatico', shape: ProductShape.CIRCULAR, widthMm: 52, heightMm: 52, widthPx: 1240, heightPx: 1240, basePrice: 270 },
  { sku: 'O-3555', name: 'Sello automático O-3555 Oval', categorySlug: 'sello-automatico', shape: ProductShape.OVAL, widthMm: 55, heightMm: 35, widthPx: 1311, heightPx: 839, basePrice: 210 },
  { sku: 'O-3045', name: 'Sello automático O-3045 Oval', categorySlug: 'sello-automatico', shape: ProductShape.OVAL, widthMm: 45, heightMm: 30, widthPx: 1075, heightPx: 720, basePrice: 185 },
  ...
  { sku: 'R-532D', name: 'Fechador R-532 D Circular', categorySlug: 'sello-fechador', shape: ProductShape.CIRCULAR, widthMm: 32, heightMm: 32, widthPx: 768, heightPx: 768, basePrice: 175 },
  { sku: 'R-542D', name: 'Fechador R-542 D Circular', categorySlug: 'sello-fechador', shape: ProductShape.CIRCULAR, widthMm: 42, heightMm: 42, widthPx: 1004, heightPx: 1004, basePrice: 235 },
  { sku: 'O-3555D', name: 'Fechador O-3555 D Oval', categorySlug: 'sello-fechador', shape: ProductShape.OVAL, widthMm: 55, heightMm: 35, widthPx: 1311, heightPx: 839, basePrice: 255 },
  { sku: 'O-3045D', name: 'Fechador O-3045 D Oval', categorySlug: 'sello-fechador', shape: ProductShape.OVAL, widthMm: 45, heightMm: 30, widthPx: 1075, heightPx: 720, basePrice: 200 },
  ...
  { sku: 'Q-24', name: 'Sello portátil Q-24 Circular', categorySlug: 'sello-portatil', shape: ProductShape.CIRCULAR, widthMm: 24, heightMm: 24, widthPx: 579, heightPx: 579, basePrice: 115 },
  { sku: 'Q-32', name: 'Sello portátil Q-32 Circular', categorySlug: 'sello-portatil', shape: ProductShape.CIRCULAR, widthMm: 32, heightMm: 32, widthPx: 768, heightPx: 768, basePrice: 135 },
  { sku: 'EL-42', name: 'Sello portátil EL-42 Circular', categorySlug: 'sello-portatil', shape: ProductShape.CIRCULAR, widthMm: 42, heightMm: 42, widthPx: 1004, heightPx: 1004, basePrice: 180 },
